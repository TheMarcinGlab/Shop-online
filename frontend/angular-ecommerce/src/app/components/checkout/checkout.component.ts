...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      customer: this.formBuilder.group({
        firstName: new UntypedFormControl('', 
                              [Validators.required, 
                               ...
                               ThisValidators.notOnlyWhitespace]),
    ...
    this.thisFormService.getCreditCardMonths(startMonth).subscribe(
      data => {
    ...
    this.thisFormService.getCreditCardYears().subscribe(
      data => {
    ...
    this.thisFormService.getCountries().subscribe(
      data => {
  ...
  getStates(formGroupName: string) {
    ...
    this.thisFormService.getStates(countryCode).subscribe(
      data => {
